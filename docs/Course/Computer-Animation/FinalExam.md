...
!!! question "2D Shape Blending 涉及的两个子问题"

    1. 顶点的对应关系问题
    2. 顶点的插值问题


!!! question "基于内在形状插值的多边形渐变方法的基本思想"
...
!!! question "二、三维形状渐变 (morphing) 各有什么优缺点？"
...
!!! question "基于星形物体的多面体 morphing 方法"
...
!!! question "Boids 模型的三条原则，每条原则的含义"
...
!!! question "Reynolds 导航方法中的追逐和躲避模型、障碍避免模型、 路径跟随、流场跟随行为模型、领导模型"
...
!!! question "Helbing 基于社会力模型的群体行为模拟方法的基本原理"
...
!!! question "运动捕获系统 (MOCAP) 流水线"

    标定 -> 捕获 -> 三维位置重建 -> 拟合到骨架 -> 后处理


!!! question "基于运动捕获的关节动画制作的优缺点"
...
!!! question "正向运动学、逆向运动学原理 (IK)，逆向雅克比方法求解 IK 的原理"
    ...
    !!! note "逆向雅克比求解 IK 的原理"
        ...
        > - 逆向雅克比问题为：$\theta = f^{-1} (X)$ ($f$ 是一个高度非线性函数)
...
!!! question "基于 Blend Shapes 表情动画的原理"
...
!!! question "布料的物理机械性能主要有哪 4 种"

    拉伸力、压缩力、剪切力和弯曲力

!!! question "布料的弹簧-质点模型主要有哪 3 种弹簧，并图示"

    ![](../../Images/2023-11-08-20-17-58.png)

!!! question "Provot 的衣服模型的原理"
